...
#ifndef CONTROLLER_HYPERV_ROUTER_H
#define CONTROLLER_HYPERV_ROUTER_H


#include "../hyperv_app.h"

class hyperv_router : public hyperv_app {
public:
    hyperv_router(pi_dev_id_t dev_id,
                  uint16_t vdp_id,
                  uint8_t inst_id,
...
#endif //CONTROLLER_HYPERV_ROUTER_H
