...
#ifndef CONTROLLER_HYPERV_SWITCH_H
#define CONTROLLER_HYPERV_SWITCH_H
...
class hyperv_switch: public hyperv_app {
public:
    hyperv_switch(pi_dev_id_t dev_id,
                  uint16_t vdp_id,
                  uint8_t inst_id,
...
#endif //CONTROLLER_HYPERV_SWITCH_H
